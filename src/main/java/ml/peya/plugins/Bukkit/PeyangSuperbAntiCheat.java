...
import ml.peya.plugins.Bukkit.Commands.CmdTst.*;
import ml.peya.plugins.Bukkit.Commands.*;
import ml.peya.plugins.Bukkit.DetectClasses.Packets;
import ml.peya.plugins.Bukkit.DetectClasses.*;
import ml.peya.plugins.Bukkit.Gui.Events.*;
import ml.peya.plugins.Bukkit.Gui.*;
import ml.peya.plugins.Bukkit.Gui.Items.Main.*;
import ml.peya.plugins.Bukkit.Gui.Items.Target.*;
import ml.peya.plugins.Bukkit.Gui.Items.Target.Page2.*;
...
public class PeyangSuperbAntiCheat extends JavaPlugin
{
    ...
    public void onEnable()
    {
        ...
        Bukkit.getMessenger().registerIncomingPluginChannel(this, "BungeeCord", new Bungee());
