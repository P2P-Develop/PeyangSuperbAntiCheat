...
### Markdown Formatting (Not so important)
...
EN:
We have put action against the offending player you reported. Thank you for your report!
```

This message is sent when the watchdog automatically detects a cheat.  
For staff kicks, you will broadcast a different message.
