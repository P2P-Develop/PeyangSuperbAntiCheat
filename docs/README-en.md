...
**IMPORTANT: This repository has jokes in commit messages by developers(and little contributor).  
...
This report format is only visible to staff, not other players.
Staff can check the contents of the report with the `[CLICK]` button.  
```\[STAFF\] \[ADMIN\] Fishy: Report of \<PlayerName\> \<Reason1\>, \[Reason2\]...```
This report format is visible to all players and lets them know who reported who and why.  
This mode is compatible with the Hypixel Lynx Mod *leaked* from █████.  
...
+ ![#008000](https://via.placeholder.com/15/008000/000000?text=+) Click to send report in **Bold Green**, or
+ ![#ff0000](https://via.placeholder.com/15/ff0000/000000?text=+) Click the **Bold Red** text to discard.
...
__Can use an alias for this reason. Please read below.__
...
This message is displayed when a staff member issues a [kick command](https://github.com/peyang-Celeron/PeyangSuperbAntiCheat/docs/README-en.md#psac-kick-playername-test).
...
| npc.panicRange | 1.5 | Specifies the relative height of the [Panic NPC](https://github.com/peyang-Celeron/PeyangSuperbAntiCheat/docs/README-en.md#acpanic-playername) and player. |
...
| skins | \(UUID\) | Specifies the skin to apply to the NPC. You can specify multiple UUIDs and it will be selected from a random UUID. |
...
__This feature is under development. Please note that you cannot study completely.__
