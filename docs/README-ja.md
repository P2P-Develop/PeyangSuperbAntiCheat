...
1.12.2 で動作確認/絶賛開発中です。「プログラムを書いてる」訳ではなく「開発」しています(~~勘違いを誘発する無駄な文章~~)  
...
SQL 関係は、[こ ↓ こ ↑](https://github.com/P2P-Develop/PeyangSuperbAntiCheat/blob/develop/docs/SQL.md) を参照してください。
