...
いずれかのアイテムを持ってクリックすることにより、プレイヤーにNPCを出すなどさまざまな操作ができます。
...
|    npc.reachRange    |       4.6       | NPCがリーチモードとして回る半径です。-rオプションがつくとこの値が使用されます。                      |
...
日本語：[れもねーど](https://github.com/lemonade19x)＆[Potato1682](https://github.com/Potato1682)
