...
- 「![#008000](https://via.placeholder.com/15/008000/000000?text=+) **レポートを送信**」の文字をクリックで送信するか、
- 「![#ff0000](https://via.placeholder.com/15/ff0000/000000?text=+) **レポートを破棄**」の文字をクリックで破棄します。  	  
